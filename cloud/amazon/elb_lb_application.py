...
def create_or_update_elb_listeners(connection, module, elb):
    ...
    if listeners is not None:
        ...
        if current_listeners:
            ...
            # the describe_listeners action returns keys as unicode so I've conceverted them to string for easier comparison
